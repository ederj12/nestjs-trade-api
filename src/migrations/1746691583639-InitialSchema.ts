...
export class InitialSchema1746691583639 implements MigrationInterface {
    name = 'InitialSchema1746691583639'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_report_reportDate" ON "reports" ("reportDate") `);
