...
export class InitialSchema1746313022421 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "portfolio_holdings" ("id" SERIAL NOT NULL, "quantity" integer NOT NULL, "averagePurchasePrice" numeric(12,2) NOT NULL, "portfolioId" integer, "stockId" integer, CONSTRAINT "UQ_39dcca5c0912814fe1e3334a489" UNIQUE ("portfolioId", "stockId"), CONSTRAINT "PK_791e8293470395842404d51142f" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "stocks" ("id" SERIAL NOT NULL, "symbol" character varying NOT NULL, "name" character varying NOT NULL, "price" numeric(12,2) NOT NULL, "lastUpdated" TIMESTAMP, "sector" character varying, "exchange" character varying, CONSTRAINT "UQ_abdd997b009437486baf7531854" UNIQUE ("symbol"), CONSTRAINT "PK_b5b1ee4ac914767229337974575" PRIMARY KEY ("id"))`,
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "portfolios" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "userId" integer NOT NULL, CONSTRAINT "PK_488aa6e9b219d1d9087126871ae" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(`CREATE INDEX "IDX_portfolio_userId" ON "portfolios" ("userId") `);
    await queryRunner.query(
      `CREATE TABLE "users" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "email" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`,
    );
